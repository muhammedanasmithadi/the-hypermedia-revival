...
SRC="assets/social/chainlink-2k.jpg"
...
"$MAGICK_BIN" "$SRC" -resize 1200x630! -strip -depth 8 assets/social/og.png
...
echo "assets: og.png, hero-1200/2400.jpg, favicon-32.png, apple-touch-icon.png regenerated"